...
const FUNCTIONS = [
  ...
  { name: 'chat-send', entry: 'src/functions/chat/sendMessage.ts' },
  { name: 'chat-process', entry: 'src/functions/chat/processMessage.ts' },
  ...
  { name: 'admin-stats', entry: 'src/functions/admin/getStats.ts' },
  { name: 'admin-analytics', entry: 'src/functions/admin/getAnalytics.ts' },
